...
export type SidebarReducerType = { [key: string]: ISection };

const INITIAL_STATE: SidebarReducerType = {
  Home: {
    link: '/',
    maxItems: 4,
    items: [],
...
export const sidebarReducer = (state = INITIAL_STATE, action: SidebarTypes) => {
  switch (action.type) {
    default:
      return state;
  }
